...
//	public static IOSDriver<MobileElement> driver;
	...
	public static String OR_reader(String fieldname) throws IOException {	
		if (platformName.equals("iOS")) {
			 reader = Files.newBufferedReader(Paths.get(getFilepath()),Charset.forName("ISO-8859-1"));
		}
		else if (platformName.equals("Android")) {
			reader = Files.newBufferedReader(Paths.get(getAndroidFilepath()),Charset.forName("ISO-8859-1"));
		}
